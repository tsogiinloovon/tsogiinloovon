...
- Added and integrated Graylog on-premise for centralized logging.
- Implemented SonarQube for continuous inspection of code quality.
...
### 2024 – 2025: Datacare LLC (Additional Experience)
- Enhanced system functionality with the integration of Graylog on-premise for real-time log aggregation and monitoring.
- Introduced SonarQube for continuous code quality inspection, ensuring better maintainability.
- Spearheaded the development of mobile applications using React Native and Flutter.
- Used Next.js to enhance web application performance with server-side rendering.
...
- **Web Development:** Angular, Servlets, HTML, CSS, JavaScript, Next.js
- **Mobile Development:** React Native, Flutter
- **Database:** MS SQL, Oracle
- **Game Development:** Unity, Unreal Engine
- **Cloud & Infrastructure:** Kubernetes, Docker
- **Code Quality & Monitoring:** Graylog (On-premise), SonarQube
- **CI/CD:** GitHub CI/CD, Kubernetes Pipelines
...
National University of Mongolia, 2019
